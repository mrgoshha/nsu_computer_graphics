...
public class MenuComponentCreator {
    ...
    // добавление остальных пунктов меню
    ...
    // создание обычного меню RadioButton, должно быть без иконки, иначе не видно какой пункт меню выбран
    ...
    // связь между меню и toolBar (при выборе пункта из главного меню, соответствующая кнопка toolBar также выбирается)
